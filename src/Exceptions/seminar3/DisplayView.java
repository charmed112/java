...
public class DisplayView<V extends View> {
    ...
    public void start() {
        ...
        do {
            String input = view.getInputData(
                    "Введите данные через пробел латинскими буквами (Фамилию Имя Отчество ДатуРождения(д.м.г) НомерТелефона(9090997411) " +
                            "Пол(f или m),\n" +
    ...
    private void writePersonData(DataCheck data) throws IOException {
        File filepath = new File("C:\\Users\\pk\\IdeaProjects\\untitled\\src\\Exceptions\\seminar3\\" + data.getLastName());

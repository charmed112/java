...
public class CompetitionGameMain {
    ...
    private static Obstacle[] createObstacles() {
        return new Obstacle[]{
                ...
                new SwimmObstacleAdapter(new SwimmingPoll(20)),
                new RoadWithStoneBallObstacleAdapter(new RoadWithStoneBall(30)),
        };
    }

    private static Participant[] createParticipants() {
        return new Participant[] {
                new StandardParticipant("Igor", 50, 30, 20,50),
                new Cat("Murzik", 60, 25, 50),
                new Cheater("Cheater")
        };
    }
